            ...
            <div className="sessions-info">
              ...
              {dropdown1 && (
                <div className={`training-description ${dropdown1 ? 'active' : ''}`}>
                  ...
                  Sessions are 30 or 60 minutes, structure varies among individuals.
                </div>
              )}
            </div>
            <div className="sessions-lines"></div>
        ...
        <form
          ...
          <div className="leftside-contact">
            <div className="main-contact-content">
              ...
              <div className="left-text">Feel free to ask any questions and I'll respond as soon as I can.</div>
            </div>
